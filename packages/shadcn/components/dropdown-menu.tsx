...
const DropdownMenuSubTrigger = ({
  ...
  children,
  ...props
}: ComponentPropsWithRef<typeof DropdownMenuSubTriggerPrimitive> & {
  inset?: boolean;
}) => (
...
const DropdownMenuSubContent = ({
  ...
  className,
  ...props
}: React.ComponentPropsWithRef<typeof DropdownMenuSubContentPrimitive>) => (
...
const DropdownMenuContent = ({
  ...
  sideOffset = 4,
  ...props
}: React.ComponentPropsWithRef<typeof DropdownMenuContentPrimitive>) => (
...
const DropdownMenuItem = ({
  ...
  inset,
  ...props
}: ComponentPropsWithRef<typeof DropdownMenuItemPrimitive> & {
  inset?: boolean;
}) => (
...
const DropdownMenuCheckboxItem = ({
  ...
  checked,
  ...props
}: React.ComponentPropsWithRef<typeof DropdownMenuCheckboxItemPrimitive>) => (
...
const DropdownMenuRadioItem = ({
  ...
  children,
  ...props
}: React.ComponentPropsWithRef<typeof DropdownMenuRadioItemPrimitive>) => (
...
const DropdownMenuLabel = ({
  ...
  inset,
  ...props
}: ComponentPropsWithRef<typeof DropdownMenuLabelPrimitive> & {
  inset?: boolean;
}) => (
...
const DropdownMenuSeparator = ({
  ...
  className,
  ...props
}: React.ComponentPropsWithRef<typeof DropdownMenuSeparatorPrimitive>) => (
